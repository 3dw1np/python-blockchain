...
class Blockchain:
    ...
    Implemented as a list of blacks - data sets of transactions.
    """
    ...
    def replace_chain(self, chain):
        ...
        - The incoming chain is longer then the local one
    ...
    def is_valid_transaction_chain(chain):
        """
        Enforce the rules of a chain composed of block of transaction.
